...
public class ReporteVentas extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Modulo de reporte de ventas");

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Fecha de busqueda"));
        ...
        btnBuscarVenta.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/buscar_1.png"))); // NOI18N
        ...
        btnExportatPDF.setText("Exportar en PDF");
    ...
    void exportarPDF() throws IOException {
        ...
        try {
            try ( Document document = new Document(PageSize.A4)) {
                ...
                pdfPTable.setWidths(new float[]{1.5f, 2.5f, 3.0f, 3.5f, 4.0f});
    ...
    void obtenerReporteVentas() {
        ...
        lblTotalMonto.setText("$" + montoVenta);
